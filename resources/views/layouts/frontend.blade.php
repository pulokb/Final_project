                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                <li><a href="mailto:pulokbiswas.cse@gmail.com"><i class="icon-mail"></i>pulokbiswas.cse@gmail.com</a></li>
                                <li><a href="#"><i class="icon-placeholder"></i>Katasur, Mohammadpur, 1207 Dhaka, Bangladesh</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="ltn__social-media">
                                            <ul>
                                                <li><a href="https://www.facebook.com/pulokbiswas24Dec" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="https://twitter.com/pulok_b" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                                                <li><a href="https://www.instagram.com/pulokbiswas_/" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                                            </ul>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('query_form') }}">Test</a></li>
                            ...
                            <div class="footer-widget footer-about-widget">
                                ...
                                <div class="footer-address">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="footer-address-info">
                                                <p><a href="mailto:pulokbiswas.cse@gmail.com">pulokbiswas.cse@gmail.com</a></p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="ltn__social-media mt-20">
                                    <ul>
                                        ...
                                        <li><a href="https://twitter.com/pulok_b" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="https://www.instagram.com/pulokbiswas_/" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                                        <li><a href="https://www.linkedin.com/in/pulokbiswas/" title="Linkedin"><i class="fab fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

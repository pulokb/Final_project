...
class EmergencyContactDataTable extends DataTable
{

    public function dataTable($query)
    {
        $dataTable = new EloquentDataTable($query);
        return $dataTable->addColumn('action', 'admin.emergency_contacts.datatables_actions')
            ->addIndexColumn()
            ->addColumn('', '')
            ->addColumn('Sl', '');
    ...
    public function query(EmergencyContact $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters(AdminHelper::datatableDesign("EmergencyContact","EmergencyContact-delete"));
    }
    ...
    {
        return 'emergency_contacts_datatable_' . time();
    }
}

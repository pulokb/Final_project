...
class UserQueryController extends AppBaseController
{
    ...
    public function index(UserQueryDataTable $userQueryDataTable)
    {
        ...
        $icon = $this->icon;
        return $userQueryDataTable->render('admin.user_queries.index',compact('icon'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.user_queries.create')->with('icon', $this->icon);
    }
    ...
    {
        $this->authorize('UserQuery-view');
        return view('admin.user_queries.show',compact('userQuery'))->with('icon', $this->icon);
    }
    ...
    public function edit(UserQuery $userQuery)
    {
        ...
        return view('admin.user_queries.edit',compact('userQuery'))->with('icon', $this->icon);
    }
